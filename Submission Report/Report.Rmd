...
author: "Mazhar Bhuyan, Jisup Kwak, Yuqi Yang"
date: "2025-04-25"
output:
  pdf_document:
...
Among all models tested, the ARIMA + NNAR Hybrid model produced one of the most accurate forecasts, outperforming the benchmark model. Incorporating Fourier terms significantly improved model performance in both neural and regression-based approaches. Temperature as a regressor showed mixed results, often increasing model complexity without clear gains.
